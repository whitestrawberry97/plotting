...
par(mfrow = c(2,2))
plot(data_new$Time, data_new$Global_active_power, type = 'l', xlab = "\n", ylab = 'Global Acitve Power (kilowatts)')
plot(data_new$Time, data_new$Voltage, type = 'l', xlab = "datetime", ylab = 'Voltage')
...
plot(data_new$Time, data_new$Global_reactive_power, type = 'l', xlab = "datetime", ylab = 'Global_reactive_power')
dev.off()
